 ...
 * @author Jon Gonzalez
 */
public class GUI004SeeController extends IncidentGenericController{
    ...
    public void initStage(Parent root){
        ...
        super.btnSignature.setOnAction((event) -> this.handleSignature(event));
